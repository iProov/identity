...
- (instancetype)initWithFormat:(NSString *)format rawCredential:(NSString *)rawCredential isDeferred:(BOOL)isDeferred notificationId:(NSString * _Nullable)notificationId __attribute__((swift_name("init(format:rawCredential:isDeferred:notificationId:)"))) __attribute__((objc_designated_initializer));
- (IdentityIssuedCredentialData *)doCopyFormat:(NSString *)format rawCredential:(NSString *)rawCredential isDeferred:(BOOL)isDeferred notificationId:(NSString * _Nullable)notificationId __attribute__((swift_name("doCopy(format:rawCredential:isDeferred:notificationId:)")));
...
- (instancetype)initWithCredentials:(NSDictionary<NSString *, IdentityIssuedCredentialData *> *)credentials errors:(NSDictionary<NSString *, IdentityOID4VCICredentialError *> *)errors cNonce:(NSString * _Nullable)cNonce __attribute__((swift_name("init(credentials:errors:cNonce:)"))) __attribute__((objc_designated_initializer));
- (IdentityOID4VCIIssuanceResult *)doCopyCredentials:(NSDictionary<NSString *, IdentityIssuedCredentialData *> *)credentials errors:(NSDictionary<NSString *, IdentityOID4VCICredentialError *> *)errors cNonce:(NSString * _Nullable)cNonce __attribute__((swift_name("doCopy(credentials:errors:cNonce:)")));
 ...
 * Map of credential configuration ID to raw credential string.
 */
@property (readonly) NSDictionary<NSString *, IdentityIssuedCredentialData *> *credentials __attribute__((swift_name("credentials")));

/**
 * Errors for credentials that failed to issue.
 * Map of credential configuration ID to error details.
 */
@property (readonly) NSDictionary<NSString *, IdentityOID4VCICredentialError *> *errors __attribute__((swift_name("errors")));
@end
...
- (instancetype)initWithId:(NSString *)id raw:(NSDictionary<NSString *, IdentityKotlinx_serialization_jsonJsonElement *> *)raw format:(NSString *)format display:(NSDictionary<id, IdentityDisplayProperties *> *)display __attribute__((swift_name("init(id:raw:format:display:)"))) __attribute__((objc_designated_initializer));
