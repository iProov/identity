 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)refreshCredentials:(NSArray<IdentityCredential *> *)credentials completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("refresh(credentials:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)refreshClaimsDocument:(IdentityCredentialIdentityCredentialMrtd * _Nullable)document reference:(IdentityCredentialIdentityCredentialReference * _Nullable)reference uris:(NSArray<IdentityCredentialUriCredential *> *)uris completionHandler:(void (^)(NSArray<IdentityJwt *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("refreshClaims(document:reference:uris:completionHandler:)")));
